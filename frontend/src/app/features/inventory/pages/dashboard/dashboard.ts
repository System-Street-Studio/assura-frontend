...
export class DashboardComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.svc.getKpis().subscribe((k: Kpi) => (this.kpis = k));
    this.svc.getCharts().subscribe((c: ChartDatasets) => {
      this.charts = c;
      this.prepareCharts();
      this.anomalies = c.anomalies;
    });
  }
